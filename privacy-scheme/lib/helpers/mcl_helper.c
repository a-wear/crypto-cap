 ...
 * @return 0 if success else -1
 */
int mcl_Fr_to_smartcard_Fr(void *buffer, size_t buffer_length, mclBnFr x)
{
 ...
 * @return 0 if success else -1
 */
int mcl_Fr_to_smartcard_Multiplier(void *buffer, size_t buffer_length, mclBnFr x)
{
    ...
    return mcl_Fr_to_smartcard_Fr((void *) &((elliptic_curve_multiplier_t *) buffer)->ecm, sizeof(elliptic_curve_fr_t), x);
}
 ...
 * @return 0 if success else -1
 */
int mcl_G1_to_smartcard_G1(void *buffer, size_t buffer_length, mclBnG1 x)
{
