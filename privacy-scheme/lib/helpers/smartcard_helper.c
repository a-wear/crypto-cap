 ...
 */
int smartcard_Fr_to_mcl_Fr(mclBnFr *x, const void *buffer, size_t buffer_length)
{
 ...
 * @return 0 if success else -1
 */
int smartcard_Multiplier_to_mcl_Fr(mclBnFr *x, const void *buffer, size_t buffer_length)
{
 ...
 * @return 0 if success else -1
 */
int smartcard_G1_to_mcl_G1(mclBnG1 *x, const void *buffer, size_t buffer_length)
{
