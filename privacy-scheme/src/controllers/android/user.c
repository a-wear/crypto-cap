                            ...
                            user_identifier_t ue_identifier, user_proof_of_key_t *proof_of_key)
{
    ...
    le = sizeof(elliptic_curve_point_t) + sizeof(elliptic_curve_fr_t) + sizeof(elliptic_curve_fr_t) + sizeof(elliptic_curve_fr_t);
    ...
    /// e <-- H(...)
    smartcard_Fr_to_mcl_Fr(&proof_of_key->e, &pbRecvBuffer[data_length], sizeof(elliptic_curve_fr_t));
    ...
    /// s values
    // s
    smartcard_Fr_to_mcl_Fr(&proof_of_key->s, &pbRecvBuffer[data_length], sizeof(elliptic_curve_fr_t));
